...
from Opus.utils.database import get_client
...
async def set_pfp(client, message):
    ...
    for num in assistants:
        ...
        try:
            ...
            await eor(message, text="ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴄʜᴀɴɢᴇᴅ ᴘꜰᴘ.")
            os.remove(photo)
...
async def set_bio(client, message):
    ...
    if len(message.command) == 1:
        return await eor(message, text="ɢɪᴠᴇ ꜱᴏᴍᴇ ᴛᴇxᴛ ᴛᴏ ꜱᴇᴛ ᴀꜱ ʙɪᴏ.")
        ...
        try:
            ...
            await eor(message, text="ᴄʜᴀɴɢᴇᴅ ʙɪᴏ.")
        except Exception as e:
            await eor(message, text=e)
    else:
        return await eor(message, text="ɢɪᴠᴇ ꜱᴏᴍᴇ ᴛᴇxᴛ ᴛᴏ ꜱᴇᴛ ᴀꜱ ʙɪᴏ.")
...
async def set_name(client, message):
    ...
    if len(message.command) == 1:
        return await eor(message, text="ɢɪᴠᴇ ꜱᴏᴍᴇ ᴛᴇxᴛ ᴛᴏ ꜱᴇᴛ ᴀꜱ ɴᴀᴍᴇ.")
    elif len(message.command) > 1:
        for num in assistants:
            client = await get_client(num)
        ...
        try:
            ...
            await eor(message, text=f"ɴᴀᴍᴇ ᴄʜᴀɴɢᴇᴅ ᴛᴏ {name} .")
        except Exception as e:
            await eor(message, text=e)
    else:
        return await eor(message, text="ɢɪᴠᴇ ꜱᴏᴍᴇ ᴛᴇxᴛ ᴛᴏ ꜱᴇᴛ ᴀꜱ ɴᴀᴍᴇ.")
    ...
    for num in assistants:
        ...
        try:
            if photos:
                ...
                await eor(message, text="ꜱᴜᴄᴄᴇꜱꜱꜰᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ᴘʜᴏᴛᴏ")
            else:
                await eor(message, text="ɴᴏ ᴘʀᴏꜰɪʟᴇ ᴘʜᴏᴛᴏꜱ ꜰᴏᴜɴᴅ.")
        except Exception as e:
            await eor(message, text=e)
